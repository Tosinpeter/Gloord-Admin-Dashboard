...
import RejectedPatientCard from './RejectedPatientCard'

const RejectedCasesSection = () => {
    ...
    return (
        <div className='flex flex-col gap-10'>
            <div className="flex flex-col gap-4">
                <h2 className='text-2xl font-semibold text-gray-900'>Rejected Cases</h2>
                <div className="flex flex-col md:flex-row gap-2 items-center justify-between w-full">
                    <p className="text-gray-600 max-w-2xl">
                        Treatment plans that have been reviewed and rejected
                    </p>
...
export default RejectedCasesSection