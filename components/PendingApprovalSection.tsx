            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col md:flex-row gap-2 items-center justify-between w-full">
                    <p className="text-gray-600 max-w-2xl">
                        Review and approve patient treatment plans waiting for your decision
                    </p>
                    <div className="flex flex-col w-full md:w-max md:flex-row gap-2 items-start md:items-center">
                        {/* Search Input */}
