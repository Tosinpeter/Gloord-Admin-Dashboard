...
const AdminHeader = () => {
    ...
    const navItems = [
        {
            ...
            icon: (isActive: boolean) => (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.8" className={isActive ? 'stroke-white' : 'stroke-tet'}>
        ...
        },
        {
            ...
            icon: (isActive: boolean) => (
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g opacity="0.8">
                        <mask id="mask0_77_14583" style={{ "maskType": "alpha" }} maskUnits="userSpaceOnUse" x="0" y="0" width="20" height="20">
                            <rect width="20" height="20" fill="#D9D9D9" />
                        </mask>
                        <g mask="url(#mask0_77_14583)">
                            <path d="M9.37484 16.3074V10.3587L4.1665 7.34263V13.1472C4.1665 13.1899 4.1772 13.2299 4.19859 13.2674C4.21998 13.3048 4.25199 13.3368 4.29463 13.3635L9.37484 16.3074ZM10.6248 16.3074L15.705 13.3635C15.7477 13.3368 15.7797 13.3048 15.8011 13.2674C15.8225 13.2299 15.8332 13.1899 15.8332 13.1472V7.34263L10.6248 10.3587V16.3074ZM9.24671 17.6712L3.66984 14.4612C3.43262 14.3245 3.24775 14.1419 3.11525 13.9133C2.98275 13.6845 2.9165 13.4334 2.9165 13.1599V6.83951C2.9165 6.56603 2.98275 6.31492 3.11525 6.08617C3.24775 5.85756 3.43262 5.67492 3.66984 5.53825L9.24671 2.32826C9.4838 2.19145 9.73484 2.12305 9.99984 2.12305C10.2648 2.12305 10.5159 2.19145 10.753 2.32826L16.3298 5.53825C16.5671 5.67492 16.7519 5.85756 16.8844 6.08617C17.0169 6.31492 17.0832 6.56603 17.0832 6.83951V13.1599C17.0832 13.4334 17.0169 13.6845 16.8844 13.9133C16.7519 14.1419 16.5671 14.3245 16.3298 14.4612L10.753 17.6712C10.5159 17.808 10.2648 17.8764 9.99984 17.8764C9.73484 17.8764 9.4838 17.808 9.24671 17.6712ZM13.213 7.41638L15.1457 6.30742L10.128 3.40513C10.0853 3.37846 10.0426 3.36513 9.99984 3.36513C9.95706 3.36513 9.91435 3.37846 9.87171 3.40513L8.06234 4.4468L13.213 7.41638ZM9.99984 9.2818L11.9373 8.15992L6.7915 5.18555L4.854 6.30742L9.99984 9.2818Z" className={isActive ? 'fill-white' : 'fill-tet'} />
                        </g>
                    </g>
                </svg>
            ),
    ...
    return (
        <>
            <div className='flex items-center justify-between gap-6 w-full py-6 relative'>
                <div className="flex items-center gap-4">
                    <button
                        onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
                        className="md:hidden p-2 border border-sec rounded-lg"
                    >
                        {isMobileMenuOpen ? (
                ...
                <div className="flex items-center gap-4 ml-0 lg:ml-0">
                    <div className="flex items-center gap-2">
                        <Link href={'/admin/notification'} className="size-12 flex items-center justify-center rounded-full border border-sec bg-white hover:bg-gray-50 transition-colors">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g opacity="0.8">
                        ...
                        <Link href={'/admin/settings'} className="size-12 flex items-center justify-center rounded-full border border-sec bg-white hover:bg-gray-50 transition-colors">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="hidden lg:block relative w-max flex-1">
                        <button
                        ...
                        >
                            ...
                            <div className="flex flex-1 flex-col gap-1 w-max text-left">
                        ...
                        <div className="p-6">
                            ...
                            <div className="flex items-center gap-3 mb-4 pb-2 border-b border-gray-200">
                                ...
                                <div className="w-full flex-1 flex flex-col gap-1">
                                    <h4 className='text-base font-medium w-max'>Dr. Sarah Johnson</h4>
