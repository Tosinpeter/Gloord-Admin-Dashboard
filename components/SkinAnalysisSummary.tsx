        ...
        <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    <span className='text-ink border border-sec rounded-full bg-white py-2 px-4 text-[13px] font-normal'>Moderate acne</span>
                    <span className='text-ink border border-sec rounded-full bg-white py-2 px-4 text-[13px] font-normal'>Post-inflammatory hyperpigmentation</span>
                    <span className='text-ink border border-sec rounded-full bg-white py-2 px-4 text-[13px] font-normal'>Uneven skin tone</span>
                </div>
            </div>
