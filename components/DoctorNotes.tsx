    ...
    return (
        <div className='flex flex-col gap-3'>
            <div className="flex items-center gap-2.5">
                <div className="size-9 flex items-center justify-center rounded-full bg-pry">
            ...
            <div className="border border-white bg-sec font-normal text-sm rounded-xl p-4 flex flex-col gap-5">
            ...
            <div className="grid grid-cols-2 gap-2.5 mt-2">
                <div className="bg-success-green text-white text-base font-normal flex items-center justify-center gap-2 rounded-full h-[40px] w-full border border-success-green focus:outline-none">
                    <CircleCheckBig size={18} />
                    Use AI Notes
                </div>
                <div className="bg-white text-base font-normal flex items-center justify-center gap-2 rounded-full h-[40px] w-full border border-black-soft focus:outline-none">
                    <CircleX size={18} />
                    Write My Own
                </div>
            </div>
