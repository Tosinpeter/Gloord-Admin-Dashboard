...
const Page = () => {
    ...
    return (
        <AccessGate pathname="/admin/case-review" allowedRole="admin">
            <div>
                <div className="container mx-auto mb-20">
                    <AdminHeader />

                <div className="mb-4 w-fit flex items-center justify-center text-sm gap-2 rounded-full py-2 px-4 bg-sec">
                    <ArrowLeft size={16} />
                    Back
                </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        <div className="max-w-[519px] w-full flex flex-col gap-4">
                            <div className="border border-[#0000001A] bg-white rounded-lg p-4 flex flex-col gap-4">
                                ...
                                <div className="bg-sec h-[1px] w-full"></div>
                                <div className="flex flex-col gap-1">
                                    <p className='capitalize text-xs font-normal tracking-[0px]'>Phone</p>
                                    <h4 className='text-base font-medium leading-[100%]'>+1 (555) 123-4567</h4>
                                </div>
                                <div className="bg-sec h-[1px] w-full"></div>
                                <div className="flex flex-col gap-1">
                                    <p className='capitalize text-xs font-normal tracking-[0px]'>Address</p>
